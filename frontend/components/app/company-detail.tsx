  ...
  return (
    <div className="space-y-10">
      <section>
        ...
        <div className="grid gap-6 rounded-card border border-border-soft bg-surface p-5 lg:grid-cols-[1fr_16rem]">
          <CompanyForm
            initial={{
              name: company.name,
          ...
          <div className="border-t border-border-soft pt-5 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
            <p className="text-xs font-medium text-ink">Statut du dossier</p>
            <div className="mt-2">
              {canManageWorkflow ? (
                <Select
